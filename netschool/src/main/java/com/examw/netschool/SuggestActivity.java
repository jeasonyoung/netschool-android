...
public class SuggestActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(tvTopTitle != null) tvTopTitle.setText(R.string.suggest_title);
		//学员名称
		final TextView txtStudentName = (TextView)this.findViewById(R.id.txt_suggest_student_name);
		if(txtStudentName != null) txtStudentName.setText(AppContext.getCurrentUsername());
		//建议内容
		...
		new AsyncTask<Void, Void, String>() {
			...
			protected String doInBackground(Void... params) {
				try{
					...
					//上传数据
					final JSONCallback<Object> callback = new APIUtils.CallbackJSON<>(SuggestActivity.this, Object.class)
