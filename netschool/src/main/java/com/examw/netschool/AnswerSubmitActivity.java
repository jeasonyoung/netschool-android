 ...
 * @since 2015年9月23日
 */
public class AnswerSubmitActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(tvTopTitle != null) tvTopTitle.setText(R.string.answer_submit_title);
		
		//所属班级
		final AppCompatSpinner classSpinner = (AppCompatSpinner)this.findViewById(R.id.ddl_class);
        ...
        if(classView != null) {
            ...
            classView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    Log.d(TAG, "点击班级下拉..." + v);
                    if(classSpinner != null) classSpinner.performClick();
                }
            });
        }
		
		//所属课程资源
		final AppCompatSpinner lessonSpinner = (AppCompatSpinner)this.findViewById(R.id.ddl_lesson);
        ...
        if(lessonView != null) {
            ...
            lessonView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(lessonSpinner != null)lessonSpinner.performClick();
                }
            });
        }
		...
		if(btnSubmit != null) btnSubmit.setOnClickListener(this);
	}
		...
		new AsyncTask<Void, Void, String>(){
			...
			protected String doInBackground(Void... params) {
				try{
					...
					//上传数据
					final JSONCallback<Object> callback = new APIUtils.CallbackJSON<>(AnswerSubmitActivity.this, Object.class)
